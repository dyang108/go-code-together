...
var socket = (0, _socket2.default)(socketName + '/index');
socket.connect();
...
function updateCount() {
  if (roomInput.value.includes(' ') || roomInput.value === '') {
    ...
    socket.emit(_lists.EventTypes.GetRoomCount, roomInput.value, function (userCount) {
      if (!userCount) {
...
},{"./components/lists":45,"socket.io-client":34}]},{},[46]);
